                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action = "{{route('Admin.tables.update',$table->id)}}">
                      ...
                      <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                          <input type="text" id="name" wire:model.lazy="name" name="name" value="{{$table->name}}" class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" required/>
                        </div>
                      </div>
                      <div class="sm:col-span-6 pt-5">
                        <label for="" class="block text-sm font-medium text-gray-700 ">guest number</label>
                        <div class="mt-1">
                          <input type="text" id="guest_number" wire:model.lazy="title" value="{{$table->guest_number}}" name="guest_number" class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" required/>
                        </div>
                      </div>
                      <div class="sm:col-span-6 pt-5">
                      ...
                      <div class="mt-6 p-4">
                      <button type ="submit" class="px-4 py-2 text-gray-700 bg-white  dark:text-gray-200 dark:bg-gray-800 rounded-lg">Store</button>
                      </div>
                    </form>
                  </div>
            </div>
