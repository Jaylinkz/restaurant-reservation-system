  ...
  <table class="table">
      ...
      <tr>
         ...
         <td>{{$user->employee_id}}</td>
              <td>
                  <a href="{{ route('lecturers.edit', $user->id ) }}" title="edit lecturer"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

                  <form method="POST" action="{{ route('lecturers.destroy',$user->id) }}" accept-charset="UTF-8" style="display:inline">
                      {{ method_field('DELETE') }}
                      {{ csrf_field() }}
