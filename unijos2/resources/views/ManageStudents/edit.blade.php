            ...
            <div class="p-2 m-2 bg-slate-100 rounded" >
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form Method="POST" action="{{route("students.update",$user->id)}}" enctype="multipart/form-data">
                      ...
                      <div class="sm:col-span-6">
                        <label for="matric_no" class="block text-sm font-medium text-gray-700">Matric_no</label>
                        <div class="mt-1">
                          <input type="text" id="matric_no"  name="matric_no" value = "{{$user->matric_no}}" class="block w-full  appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" required/>
                        </div>
