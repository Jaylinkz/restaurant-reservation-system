            ...
            <main class = "m-2 p-8 w-full">
                <div>
                    @if(session()->has('danger'))
                        <div class="text-white px-6 py-4 border-0 rounded relative mb-4 bg-rose-500 .bg-red-500">
                            <span class="text-xl inline-block mr-5 align-middle">
                              <i class="fas fa-bell" />
                              </span>
                            <span class="inline-block align-middle mr-8">
                           <b class="capitalize">{{session()->get('danger')}}</b> 
                          </span>
                        </div>
                    @endif
                    @if(session()->has('warning'))
                        ...
                        <span class="inline-block align-middle mr-8">
                       <b class="capitalize">{{session()->get('warning')}}</b> 
                      </span>
                    </div>
                @endif
